...
export const KecamatanSummaryTable: React.FC = () => {
  const { kecamatanData, hthData, chshMonthly, chshDasarian, chshPredictionPlus1, chshPredictionPlus2, chshPredictionPlus3 } = useKecamatanStore();
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Ringkasan Data Per Kecamatan</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {KECAMATAN_LIST.map((kab) => {
                  const kabData = kecamatanData[kab];
