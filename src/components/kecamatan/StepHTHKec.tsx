...
import { useKecamatanStore } from '@/store/kecamatanStore';
...
export const StepHTHKec: React.FC = () => {
  const { hthData, updateHTHData } = useKecamatanStore();
  ...
  const handleProcess = useCallback(async () => {
    ...
    try {
      ...
      for (const feature of geojson.features) {
        ...
        // Filter points dalam kecamatan ini
        ...
        // HTH_kering = 1 if Hmax (maximum HTH in kecamatan) > 30 days
        ...
        // HTH_basah = 1 if Hmin (minimum HTH in kecamatan) < 5 days or "masih hujan"
      ...
      toast({
        ...
        description: `HTH berhasil dihitung untuk ${Object.keys(results).length} kecamatan`,
      });
    } catch (error) {
